...
def draw_scene(trace: dict, out_path: Path, np_rng: np.random.Generator) -> None:
    ...
    n_clutter = {"low": 7, "medium": 25, "high": 52}[clutter]
    ...
    if trace["ood_axis"] == "occlusion":
        ox0, oy0, ox1, oy1 = safe_rect(np_rng, protected, (180, 280), (18, 28))
        blend_rect(base, ox0, oy0, ox1, oy1, "gray", 0.58)
        ox0, oy0, ox1, oy1 = safe_rect(np_rng, protected, (220, 340), (16, 26), (45, WIDTH - 45), (290, HEIGHT - 40))
        blend_rect(base, ox0, oy0, ox1, oy1, "black", 0.42)
