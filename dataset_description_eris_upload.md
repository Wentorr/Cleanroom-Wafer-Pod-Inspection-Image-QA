...
This synthetic dataset contains rendered inspection panels for 300 mm FOUP/load-port handoff checks in semiconductor cleanroom operations. Each PNG image shows a single inspection moment with a wafer-carrier slot map, digital purge/pressure gauge, module LEDs, robot arm, carrier handoff ports, route strip, lot code, and visual defect marker.
...
The operational vocabulary is grounded in semiconductor carrier handling rather than generic manufacturing VQA. SEMI E47.1 covers FOUPs used to transport and store 300 mm wafers, SEMI E15 covers tool load-port interfaces, and SEMI E84 covers enhanced carrier handoff signals between production equipment and automated material handling. This dataset is not a copy of any SEMI document or real fab data; it is a deterministic synthetic benchmark inspired by those publicly documented operational concepts.
...
- SEMI E47.1: Mechanical Specification for FOUPs Used to Transport and Store 300 mm Wafers - https://store-us.semi.org/products/e04701-semi-e47-1-mechanical-specification-for-foups-used-to-transport-and-store-300-mm-wafers
- SEMI E15: Specification for Tool Load Port - https://store-us.semi.org/products/e01500-semi-e15-specification-for-tool-load-port
- SEMI E84: Specification for Enhanced Carrier Handoff Parallel I/O Interface - https://store-us.semi.org/products/e08400-semi-e84-specification-for-enhanced-carrier-handoff-parallel-i-o-interface
